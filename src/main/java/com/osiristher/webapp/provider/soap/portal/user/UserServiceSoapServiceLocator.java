...
public class UserServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.osiristher.webapp.provider.soap.portal.user.UserServiceSoapService {
    ...
    private java.lang.String Portal_UserService_address = "http://localhost:8008/api/axis/Portal_UserService";
    ...
    public com.osiristher.webapp.provider.soap.portal.user.UserServiceSoap getPortal_UserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.osiristher.webapp.provider.soap.portal.user.Portal_UserServiceSoapBindingStub _stub = new com.osiristher.webapp.provider.soap.portal.user.Portal_UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.osiristher.webapp.provider.soap.portal.user.UserServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.osiristher.webapp.provider.soap.portal.user.Portal_UserServiceSoapBindingStub _stub = new com.osiristher.webapp.provider.soap.portal.user.Portal_UserServiceSoapBindingStub(new java.net.URL(Portal_UserService_address), this);
                _stub.setPortName(getPortal_UserServiceWSDDServiceName());
                return _stub;
            }
        }
