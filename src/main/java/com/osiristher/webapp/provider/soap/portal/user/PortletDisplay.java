...
public class PortletDisplay  implements java.io.Serializable {
    ...
    private com.osiristher.webapp.provider.soap.portal.user.StringBundler content;
    ...
    public PortletDisplay(
           ...
           int columnPos,
           com.osiristher.webapp.provider.soap.portal.user.StringBundler content,
     ...
     * @return content
     */
    public com.osiristher.webapp.provider.soap.portal.user.StringBundler getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(com.osiristher.webapp.provider.soap.portal.user.StringBundler content) {
        this.content = content;
    }
