...
public class UserGroupRoleSoap  implements java.io.Serializable {
    ...
    private com.osiristher.webapp.provider.soap.portal.user.UserGroupRolePK primaryKey;
    ...
    public UserGroupRoleSoap(
           long groupId,
           com.osiristher.webapp.provider.soap.portal.user.UserGroupRolePK primaryKey,
           long roleId,
           long userId) {
     ...
     * @return primaryKey
     */
    public com.osiristher.webapp.provider.soap.portal.user.UserGroupRolePK getPrimaryKey() {
        return primaryKey;
    }
     ...
     * @param primaryKey
     */
    public void setPrimaryKey(com.osiristher.webapp.provider.soap.portal.user.UserGroupRolePK primaryKey) {
        this.primaryKey = primaryKey;
    }
